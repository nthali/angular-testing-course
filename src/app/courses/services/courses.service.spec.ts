...
describe( 'CoursesService', () => {
    ...
    it('should find a course by id', () => {
        coursesService.findCourseById(12).subscribe( course => {
            expect( course.id ).toBe( 12, "wrong course returned" );
            expect( course.titles.description ).toBe( "Angular Testing Course" );
        });
    ...
    it('should save course changes', () => {
        const changes : Partial<Course> = { titles: { description: 'Angular Master Testing Course' } };
    ...
    it('should find a list of lessons', () => {
        coursesService.findLessons(12, "", "desc", 1, 3).subscribe( 
            (lessons => {
